 ...
 */
final class Version20221121173510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE acoge ADD gato_id INT DEFAULT NULL, ADD perro_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE acoge ADD CONSTRAINT FK_1F0C15A7E6C2CC92 FOREIGN KEY (gato_id) REFERENCES gato (id)');
        $this->addSql('ALTER TABLE acoge ADD CONSTRAINT FK_1F0C15A72F41C9A9 FOREIGN KEY (perro_id) REFERENCES perro (id)');
        $this->addSql('CREATE INDEX IDX_1F0C15A7E6C2CC92 ON acoge (gato_id)');
        $this->addSql('CREATE INDEX IDX_1F0C15A72F41C9A9 ON acoge (perro_id)');
        $this->addSql('ALTER TABLE adopta ADD gato_id INT DEFAULT NULL, ADD perro_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE adopta ADD CONSTRAINT FK_588ACEE8E6C2CC92 FOREIGN KEY (gato_id) REFERENCES gato (id)');
        $this->addSql('ALTER TABLE adopta ADD CONSTRAINT FK_588ACEE82F41C9A9 FOREIGN KEY (perro_id) REFERENCES perro (id)');
        $this->addSql('CREATE INDEX IDX_588ACEE8E6C2CC92 ON adopta (gato_id)');
        $this->addSql('CREATE INDEX IDX_588ACEE82F41C9A9 ON adopta (perro_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE acoge DROP FOREIGN KEY FK_1F0C15A7E6C2CC92');
        $this->addSql('ALTER TABLE adopta DROP FOREIGN KEY FK_588ACEE8E6C2CC92');
        $this->addSql('ALTER TABLE acoge DROP FOREIGN KEY FK_1F0C15A72F41C9A9');
        $this->addSql('ALTER TABLE adopta DROP FOREIGN KEY FK_588ACEE82F41C9A9');
        ...
        $this->addSql('DROP INDEX IDX_1F0C15A7E6C2CC92 ON acoge');
        $this->addSql('DROP INDEX IDX_1F0C15A72F41C9A9 ON acoge');
        $this->addSql('ALTER TABLE acoge DROP gato_id, DROP perro_id');
        $this->addSql('DROP INDEX IDX_588ACEE8E6C2CC92 ON adopta');
        $this->addSql('DROP INDEX IDX_588ACEE82F41C9A9 ON adopta');
        $this->addSql('ALTER TABLE adopta DROP gato_id, DROP perro_id');
    }
}
