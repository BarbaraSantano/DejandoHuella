 ...
 */
final class Version20221123154522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE gato CHANGE fecha_nacimiento fecha_nacimiento VARCHAR(255) DEFAULT NULL');
