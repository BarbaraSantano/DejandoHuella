 ...
 */
class getSocioRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SocioRepository' shared autowired service.
     *
     * @return \App\Repository\SocioRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SocioRepository.php';

        return $container->privates['App\\Repository\\SocioRepository'] = new \App\Repository\SocioRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
