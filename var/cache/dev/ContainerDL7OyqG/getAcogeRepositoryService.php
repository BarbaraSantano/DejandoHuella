 ...
 */
class getAcogeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AcogeRepository' shared autowired service.
     *
     * @return \App\Repository\AcogeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AcogeRepository.php';

        return $container->privates['App\\Repository\\AcogeRepository'] = new \App\Repository\AcogeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
