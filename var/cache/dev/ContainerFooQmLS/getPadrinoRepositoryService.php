 ...
 */
class getPadrinoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PadrinoRepository' shared autowired service.
     *
     * @return \App\Repository\PadrinoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PadrinoRepository.php';

        return $container->privates['App\\Repository\\PadrinoRepository'] = new \App\Repository\PadrinoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
