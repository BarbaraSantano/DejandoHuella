 ...
 */
class getAdoptaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AdoptaRepository' shared autowired service.
     *
     * @return \App\Repository\AdoptaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AdoptaRepository.php';

        return $container->privates['App\\Repository\\AdoptaRepository'] = new \App\Repository\AdoptaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
